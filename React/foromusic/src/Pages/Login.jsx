    ...
    return (
        <main>
            ...
            <form method="POST" action="javascript:void(0);" className="forms">
                <p>Email:</p>
                <input className="logs" id="mail" type="email" name="mail" placeholder="Enter your Email" onChange={(e) => changeMail(e.target.value)} />
                <p>Password:</p>
                <input className="logs" id="password" type="password" name="password" placeholder="Enter your Password" onChange={(e) => changePassword(e.target.value)} />
